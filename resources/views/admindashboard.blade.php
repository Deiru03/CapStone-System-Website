<x-admin-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.clearances') }}" class="bg-blue-500 text-white p-6 rounded-lg shadow-lg relative hover:bg-blue-600 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                    ...
                    <p class="text-2xl">{{ $totalClearances }}</p>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="absolute right-8 top-1/2 transform -translate-y-1/2 h-10 w-10">
    ...
    <!-- Add this after the closing </div> of the grid containing the dashboard boxes -->
    <div class="mt-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                <h3 class="text-xl font-medium mb-4">Clearance Status</h3>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="bg-yellow-500 text-blue-900 font-semibold px-2 py-0.5 rounded">Pending</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $pendingClearances }}</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="bg-green-500 text-blue-900 font-semibold px-2 py-0.5 rounded">Signed</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $signedClearances }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                <h3 class="text-xl font-medium mb-4">Faculty Status</h3>
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">Permanent</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $permanentFacultyCount }}</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">Part-Timer</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $partTimeFacultyCount }}</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">Temporary</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $temporaryFacultyCount }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
